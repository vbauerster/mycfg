...
map -docstring 'reduce and insert'          global anchor 'i'       ';i'
map -docstring 'reduce and append'          global anchor 'a'       ';a'
map -docstring 'slice by word'              global anchor 'w'       ': slice-by-camel<ret>'
map -docstring 'shift selection left'       global anchor '<lt>'    ': shift-selection-left<ret>'
map -docstring 'shift selection right'      global anchor '<gt>'    ': shift-selection-right<ret>'
