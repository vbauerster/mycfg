...
plug "occivink/kakoune-expand" config %{
    ...
    map -docstring "smart expand" global normal 'Q' ': expand<ret>'
}

plug "delapouite/kakoune-buffers" config %[
    hook global WinDisplay .* info-buffers
    map global normal '}'     ': enter-user-mode buffers<ret>'       -docstring 'buffers'
    map global normal '<a-}>' ': enter-user-mode -lock buffers<ret>' -docstring 'buffers (lock)'
    map global normal '<plus>'     '}'
    map global normal '<a-plus>' '<a-}>'
]
...
plug "occivink/kakoune-phantom-selection" config %{
    ...
    map -docstring 'phantom selection add'           global phantom 'a'      ': phantom-selection-add-selection<ret>'
    map -docstring 'phantom selection add and next'  global phantom 'A'      ': phantom-selection-add-selection;phantom-selection-iterate-next<ret>'
    ...
    map -docstring 'clear'                           global phantom 'c'      ': phantom-selection-clear<ret>'
    map -docstring 'select all and clear'            global phantom 'q'      ': phantom-selection-select-all; phantom-selection-clear<ret>'
...
plug "ul/kak-lsp" do %{
    ...
    hook global WinSetOption filetype=(go|rust) %{
        ...
        map -docstring "lsp-references-next-match"      window lsp ']' ': lsp-references-next-match;enter-user-mode lsp<ret>'    
        map -docstring "lsp-references-previous-match"  window lsp '[' ': lsp-references-previous-match;enter-user-mode lsp<ret>'
...
plug "alexherbo2/move-line.kak" config %{
    map -docstring 'move line below' global view 'd' '<esc>: move-line-below %val{count}<ret>'
    map -docstring 'move line above' global view 'u' '<esc>: move-line-above %val{count}<ret>'
    map -docstring 'move line below (sticky)' global view 'D' '<esc>: move-line-below %val{count}<ret>v'
    map -docstring 'move line above (sticky)' global view 'U' '<esc>: move-line-above %val{count}<ret>v'
}
